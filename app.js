// HC: consider moving store variable into a separate file
const store = [
  {
    question: 'What is the capital of Japan?',
    answers: ['Osaka', 'Kyoto', 'Fukuoka', 'Tokyo'],
    correctAnswer: 'Tokyo',
    website:
  ...
  },
  {
    ...
    answers: ['Hsinchu', 'Taipei', 'Kaohsiung', 'Tainan'],
    correctAnswer: 'Taipei',
    website:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Flag_of_the_Republic_of_China.svg/2000px-Flag_of_the_Republic_of_China.svg.png'
  },
  {
    question: 'What is the capital of China?',
    answers: ['Beijing', 'Shanghai', 'Shenzhen', 'Nanjing'],
  ...
  },
  {
    ...
    answers: ['Busan', 'Incheon', 'Seoul', 'Gimpo'],
    correctAnswer: 'Seoul',
    website:
  ...
  },
  {
    ...
    answers: ['Ottawa', 'Toronto', 'Montreal', 'Ontario'],
  ...
  },
  {
    ...
    answers: ['Guadalajara', 'Puebla', 'Cancún', 'Mexico City'],
    correctAnswer: 'Mexico City',
    website:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Flag_of_Mexico.svg/2000px-Flag_of_Mexico.svg.png'
  },
  {
    question: 'What is the capital of the United Kingdom?',
    answers: ['Liverpool', 'Bristol', 'London', 'Glasgow'],
  ...
  },
  {
    ...
    answers: ['Florence', 'Venice', 'Milan', 'Rome'],
    correctAnswer: 'Rome',
...
function generateQuestion() {
  if (questNum < store.length) {
    ...
    // HC: could you perhaps have used a loop here?
...
// HC: don't forget to remove any console.log statements that you don't need anymore
...
// HC: this comment below could be more descriptive
//select function
...
function renderResults() {
  ...
  if (score >= 7) {
    // HC: consider creating a helper function for lines 210-213 and then use that helper function
    // for lines 216-219 and lines 221-224
    resultImg.style.display = 'block';
    resultImg.src =
      'https://thumbor.thedailymeal.com/260hkFEzsOuCmmxztIpZncts5c4=/774x516/https://www.theactivetimes.com/sites/default/files/uploads/0/0-shutterstock_397569799.jpg';
    startQuestion.innerHTML = `You know your countries!<br> Your score was ${score}/10`;
  } else if (score > 4 && score < 7) {
    resultImg.style.display = 'block';
    resultImg.src =
      'https://www.euroweeklynews.com/wp-content/uploads/2018/11/shutterstock_232923259-696x464.jpg';
    startQuestion.innerHTML = `You seem like you kind of know your stuff.<br> Your score was ${score}/10`;
  } else {
    resultImg.style.display = 'block';
    resultImg.src =
      'https://www.gtitravel.com/wp-content/uploads/2017/06/Do-Travel-Agents-get-free-trips-1030x686.jpg';
